...
from app.crud.schedule import sync_schedule_with_lessons_crud, delete_schedule, insert_schedule
...
from app.mstimetables.service import get_schedule_from_mstimetables, get_lessons_from_mstimetables
